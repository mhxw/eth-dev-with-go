...
Ethereum is quickly evolving and things may go out of date sooner than anticipated. I strongly suggest opening an [issue](https://github.com/mhxw/eth-dev-with-go/issues) or making a [pull request](https://github.com/mhxw/eth-dev-with-go/pulls) if you observe things that can be improved. This book is completely open and free and available on [github](https://github.com/mhxw/eth-dev-with-go).

#### Online

[https://mhxw.life/eth-dev-with-go](https://mhxw.life/eth-dev-with-go)
