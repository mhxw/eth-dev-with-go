...
[Exchange.sol](https://github.com/mhxw/eth-dev-with-go/blob/main/code/contracts_0xprotocol/Exchange.sol)
...
[event_read_0xprotocol.go](https://github.com/mhxw/eth-dev-with-go/blob/main/code/event_read.go)
