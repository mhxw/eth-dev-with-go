...
const config = {
  ...
  tagline: '用Go来做以太坊开发',
  url: 'https://mhxw.life',
  baseUrl: '/eth-dev-with-go/',
  onBrokenLinks: 'ignore',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'mhxw', // Usually your GitHub org/user name.
  projectName: 'eth-dev-with-go', // Usually your repo name.
  presets: [
    [
      'classic',
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/mhxw/eth-dev-with-go/tree/dev/',
        },
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/mhxw/eth-dev-with-go',
            label: 'GitHub',
            position: 'right',
          },
        ],
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: 'https://mhxw.life/solidity-by-example/',
              },
            ],
          },
          {
